...
export const subsectorCategories = [
  {
    ...
    color: '#c0392b',
    subsectors: [
      { code: 'F1', name: 'Contract Manufacturing / Co-Man - Food', description: 'Co-manufacturers of snacks, bars, bakery, beverages, frozen, and shelf-stable products; turnkey production and packaging; private label producers for retailers' },
      { code: 'F2', name: 'Contract Manufacturing / Co-Man - Bakery Specific', description: 'Fresh, frozen, and shelf-stable baked goods; breads, buns, pastries, sweet goods; includes branded, in-store bakery, and private label' },
      { code: 'F3', name: 'Ingredients & Flavors', description: 'Flavor houses, extracts, functional ingredients, proteins, enzymes, botanicals; technical + R&D-led B2B suppliers to food manufacturers' },
      { code: 'F4', name: 'Dairy - Branded & Private Label', description: 'Milk, cultured dairy, cheese, creamers, ice cream; mix of refrigerated and frozen; includes processors and manufacturers' },
      { code: 'F5', name: 'Food Distribution - Specialty', description: 'Specialty food distributors, fresh distribution, cold-chain logistics, foodservice ingredient suppliers, institutional channels' },
      { code: 'F6', name: 'Beverages - Non-Alcoholic (Branded)', description: 'RTD beverages, juices, teas, coffees, functional beverages, hydration drinks, energy alternatives (branded products, not co-man)' },
      { code: 'F7', name: 'Beverages - Contract Manufacturing', description: 'Contract beverage production for brands; filling, packaging, formulation services' },
      { code: 'F8', name: 'Better-For-You / Natural / Specialty Brands', description: 'Clean label, premium positioning, specialty category focus, modern flavor profiles; often natural channel + omni-channel (branded products)' },
      { code: 'F9', name: 'Branded Packaged Food - Traditional', description: 'Traditional packaged food brands: shelf-stable, refrigerated, or frozen (ex: dairy or bakery); typically center-aisle or mass-channel' },
    ]
  },
  {
    id: 'restaurants',
