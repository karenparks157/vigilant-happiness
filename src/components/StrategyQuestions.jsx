...
export default function StrategyQuestions({ strategyAnswers, setStrategy, onNext, onPrev }) {
  return (
    <div className="max-w-3xl mx-auto">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-navy-900 mb-2">Strategy & Open-Ended</h2>
        <p className="text-navy-600">
          Share your strategic thinking and any additional perspectives with the partnership.
        </p>
      </div>
